...
<div class="w3-top w3-mobile" style="position: relative">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="<?php echo base_url('chat'); ?>" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Messages"><i class="fa fa-envelope"></i></a>
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Publica algo para tus amigos</h6>
              <form id="frm-publicar" action="<?php echo base_url('Publicacion/publicar')?>" method="POST">
                <textarea id="publicarTexto" name="publicarTexto" class="w3-border w3-padding" style="width: 100%; z-index: 0" rows="3" placeholder="Publica algo"></textarea> 
                ...
                <p style="width: 100%">Suba una foto y seleccione el album</p>
                <input type="file" class="custom-file-input w3-border w3-padding" accept="image/x-png,image/jpeg" id="customFileLang" lang="es" name="foto" style="width: 50%">
                <select class="w3-select w3-border w3-padding" id="publicarSelectAlbum" name="publicarSelectAlbum" style="width: 45%">
                  <?php 
                    foreach ($albums as $value){ 
                      echo "<option value='$value->id_album'>$value->ruta</option>";
                    }
                  ?>
                </select>
...
<script type="text/javascript" src="<?=base_url_assets.'assets/js/publicar.js' ?>"></script>
